...
class Informe extends Controller {
	...
	function venta_fpago(){
		$this->view->Pago = $this->model->Pago();
	...
	function venta_credit_per(){
		$this->view->js = array('informe/js/inf_ven_credit_per.js');
		$this->view->render('informe/venta/credit_personal', false);
	}

	function venta_credit_per_list(){
		$this->model->venta_credit_per_list($_POST);
	}
	...
	/* COMANDA DE MESERO */
	function comanda_mesero(){
		$this->view->Mozo = $this->model->Mozo();
		$this->view->Salon = $this->model->Salon();
		$this->view->Mesa = $this->model->Mesa();
		$this->view->js = array('informe/js/inf_comanda_mesero.js');
		$this->view->render('informe/operacion/comanda_mesero', false);
	}
	function comanda_mesero_list() {
        $this->model->comanda_mesero_list($_POST);
    }	
