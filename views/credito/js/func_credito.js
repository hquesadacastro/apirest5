...
var listar = function(){
	...
	.DataTable({
        ...
                return '<span class="p-1 badge badge-danger font-12 p-5"> '+moneda+' '+formatNumber(data)+'</span>';
            }},
        ...
                return '<span class="p-1 badge badge-warning font-12 p-5"> '+moneda+' ' +formatNumber(cal)+'</span>';
            }},
            {"data":null,"render": function ( data, type, row ) {
                var call = (data.total - data.Amortizado.total).toFixed(2);
                return '<div class="text-right"><a href="javascript:void(0)" class="text-info edit" onclick="detalle('+data.id_credito+',\''+data.desc_td+'\',\''+data.numero+'\')"><i data-feather="eye" class="feather-sm fill-white"></i>Ver detalle</a>'
                    +'&nbsp;&nbsp;<a href="javascript:void(0)" class="text-success delete ms-2" onclick="pagoCuota('+data.id_credito+')"><i data-feather="plus-circle" class="feather-sm fill-white"></i>Pagar credito</a></div>';
            }}
		],
