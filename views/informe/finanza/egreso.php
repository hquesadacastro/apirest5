...
<div class="row page-titles">
    <div class="col-md-5 col-8 align-self-center">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Todos los egresos</li>
        </ol>
    </div>
</div>
<div class="row">
        ...
        <div class="card">
            ...
            <div class="card-body p-b-0">
                <div class="card-body-1">
                    ...
                    <span class="float-right btn btn-rounded btn-primary btn-nuevo" style="text-align:right;" id="btn-excel"></span>                
                </div>
                <br>
                <div class="message-box contact-box">
                    ...
                    <div class="row floating-labels m-t-10">
                        ...
                        <div class="form-group col-lg-3 offset-lg-2 m-b-40">
            ...
            <div class="text-center m-b-20">
                <div class="row">
                    <div class="col-6">
                        <h2 class="font-medium text-warning m-b-0 font-30 egresos-operaciones"></h2>
                        <h6 class="font-bold m-b-10">N° Operaciones</h6>                            
                    </div>
                    <div class="col-6">
                        <h2 class="font-medium text-warning m-b-0 font-30 egresos-total"></h2>
                        <h6 class="font-bold m-b-10">Total de Egresos</h6>
                    </div>
                </div>
            </div>
