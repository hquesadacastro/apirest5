        ...
        <div class="card">
            <div class="card-body p-0 bg-estado">
                <div class="text-center m-t-15">
                    <h5 class="card-title text-white m-b-15">Acciones</h5>
                </div>
            </div>
            <div class="card-body row">
                <div class="col-4 col-md-4 px-0">
                        <a class="text-center d-block" href="<?php echo URL; ?>informe/finanza_arq_imp/<?php echo $this->apc; ?>" target="_blank">
                            <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-printer feather-sm fill-white" style="width: 25px; height: 25px"><polyline points="6 9 6 2 18 2 18 9"></polyline><path d="M6 18H4a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-2"></path><rect x="6" y="14" width="12" height="8"></rect></svg><br>Imprimir</a>
                </div>
                <div class="col-4 col-md-4 px-0">
                    <a class="text-center d-block" href="<?php echo URL; ?>informe/finanza_arq_resumen_imp/<?php echo $this->apc; ?>/productos" target="_blank">
                        <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-archive feather-sm fill-white" style="width: 25px; height: 25px"><polyline points="21 8 21 21 3 21 3 8"></polyline><rect x="1" y="3" width="22" height="5"></rect><line x1="10" y1="12" x2="14" y2="12"></line></svg><br>Productos</a>
                </div>
                <div class="col-4 col-md-4 px-0">
                    <a class="text-center d-block" href="#" target="_blank">
                        <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-list feather-sm fill-white" style="width: 25px; height: 25px"><line x1="8" y1="6" x2="21" y2="6"></line><line x1="8" y1="12" x2="21" y2="12"></line><line x1="8" y1="18" x2="21" y2="18"></line><line x1="3" y1="6" x2="3" y2="6"></line><line x1="3" y1="12" x2="3" y2="12"></line><line x1="3" y1="18" x2="3" y2="18"></line></svg><br>Gastos</a>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 b-r p-10">
                                    <div class="d-flex m-l-20">
                                        <div class="display-7 text-mute"><i class="ti ti-wallet"></i></div>
                                        <div class="m-l-10">
                                            <h4 class="font-regular text-mute m-b-0 c-monto-tra"></h4>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 p-10 align-self-center">
                                    <div class="d-flex m-l-20">
                                        ...
                                        <div class="m-l-10">
                                            <h4 class="font-regular text-mute m-b-0 c-monto-yape"></h4>
                                            <small>Yape</small>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 p-10 align-self-center">
                                    <div class="d-flex m-l-20">
                                        <div class="display-7 text-mute"><i class="ti ti-credit-card"></i></div>
                                        <div class="m-l-10">
                                            <h4 class="font-regular text-mute m-b-0 c-monto-plin"></h4>
                                            <small>Plin</small>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 p-10 align-self-center">
                                    <div class="d-flex m-l-20">
                                        <div class="display-7 text-mute"><i class="ti ti-credit-card"></i></div>
                                        <div class="m-l-10">
                                            <h4 class="font-regular text-mute m-b-0 c-monto-lin"></h4>
