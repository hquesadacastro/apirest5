        ...
        <div class="card">
            <div class="card-body p-b-0">
                <div class="card-body">
                    ...
                    <h4 class="card-title">Ventas por delivery</h4>
                </div>
                    ...
                    <table id="table" class="table table-hover table-condensed stylish-table" width="100%">
                        <thead class="table-head">
                            <tr>
                                ...
                                <th width="10%">Repartidor</th>
                                <th width="15%">Documento</th>                               
                                <th class="text-right" width="10%">Entrega</th>
                                <th class="text-right" width="10%">Total consumido</th>
                                <th class="text-right" width="10%">Comision</th>
                    ...
                    <table class="table m-b-0">
                        <tfooter>
                            ...
                            <tr>
                                ...
                                <td class="total-descuento text-right"></td>
                            </tr>
                            <tr>
                                <td width="85%" class="text-right">Total Comisión:</td>
                                <td class="total-comision text-right"></td>
                            </tr>
                            <tr>
                                <td width="80%" class="text-right text-success">Total facturado:</td>
                                <td class="total-facturado text-right"></td>
                            </tr>
                        </tfooter>
                    </table>
                </div>
