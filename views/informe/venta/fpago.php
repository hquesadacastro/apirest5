        ...
        <div class="card">
                ...
                <div class="message-box contact-box">
                    ...
                    <div class="row floating-labels m-t-5">
                        ...
                        <div class="col-lg-2 offset-lg-6">
                            <div class="form-group m-b-40">
                                <select class="selectpicker form-control" name="filtro_pago" id="filtro_tipo_pago" data-style="form-control btn-default" data-live-search="true" autocomplete="off" data-size="5">
            ...
            <div class="text-center m-b-20">
                <div class="row">
                    ...
                    <div class="col-2">
                        <h2 class="font-medium text-warning m-b-0 font-30 visa-total"></h2>
                        <h6 class="font-bold m-b-10">Total de Visa</h6>
                    </div>
                    <div class="col-2">
                        <h2 class="font-medium text-warning m-b-0 font-30 mastercard-total"></h2>
                        <h6 class="font-bold m-b-10">Total de Mastercard</h6>
                    </div>
                    <div class="col-2">
                        <h2 class="font-medium text-warning m-b-0 font-30 yape-total"></h2>
                        <h6 class="font-bold m-b-10">Total de Yape</h6>
                    </div>
                    <div class="col-2">
                        <h2 class="font-medium text-warning m-b-0 font-30 plin-total"></h2>
                        <h6 class="font-bold m-b-10">Total de Plin</h6>
                    </div>
                </div>
            </div>
                    ...
                    <table id="table" class="table table-hover table-condensed stylish-table" width="100%">
                        <thead class="table-head">
                            <tr>
                                ...
                                <th width="15%">Cod. Operacion</th>
                                <th class="text-right">Total</th>
                                <th class="text-right">Efectivo</th>
                                <th class="text-right">Visa</th>
                                <th class="text-right">Mastercard</th>
                                <th class="text-right">Yape</th>
                                <th class="text-right">Plin</th>
                            </tr>
                        </thead>
