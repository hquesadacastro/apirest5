...
<input type="hidden" id="tribAcr" value="RUC"/>
<input type="hidden" id="diAcr" value="DNI"/>
                    ...
                    <table id="table" class="table table-hover table-condensed stylish-table" width="100%">
                        <thead class="table-head">
                            <tr>
                                ...
                                <th width="10%">Canal venta</th>                               
                                <th class="text-right" width="7%">Total</th>
                                <th width="8%" class="text-center">Estado</th>
                                <th class="text-right" width="3%">Opciones</th>
                            </tr>
                        </thead>
