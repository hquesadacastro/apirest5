...
var listar = function(){
	...
	.DataTable({
        buttons: [
            {
                extend: 'excel', title: 'rep_egeresos', text:'Excel', text: '<i class="mdi mdi-file-excel display-6" style="line-height: 10px;"><span class="botones-excel">Exportar excel</span></i>', titleAttr: 'Descargar Excel',
                container: '#btn-excel'
            }
        ],
		"destroy": true,
        ...
            }},
            ...
            },
            {
                ...
                "render": function ( data, type, row ) {
                    if(data.estado == 'a'){
                        return '<p class="text-center"><span class="text-white badge bg-success">APROBADO</span></p>';
                    } else if(data.estado == 'i'){
                        return '<p class="text-center"><span class="text-white badge bg-danger">ANULADO</span></p>';
                    }
                }
            }
		],
