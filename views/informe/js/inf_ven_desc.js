...
var listar = function(){
    ...
    .DataTable({
        buttons: [
            {
                extend: 'excel', title: 'Descuentos', className: 'dropdown-item', text: '<i class="fas fa-file-excel"></i> Descargar en excel', titleAttr: 'Descargar Excel',
                container: '#excel', exportOptions: { columns: [0,1,2,3,4,5,6] }
            },
            {
                extend: 'pdf', title: 'Descuentos', className: 'dropdown-item', text: '<i class="fas fa-file-pdf"></i> Descargar en pdf', titleAttr: 'Descargar Pdf',
