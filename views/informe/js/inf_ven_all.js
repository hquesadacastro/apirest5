...
var listar = function(){
    ...
    var table = $('#table').DataTable({
        ...
                return '<div class="mayus">'+data+'</div>';
            ...
            data: null,
            render: function(data, type, row) {
                return 1 == data.Cliente.tipo_cliente ? data.Cliente.nombre.toUpperCase() + '<br><span class="font-12"> ' + $("#diAcr").val() + ": " + data.Cliente.dni + "</span>" : 2 == data.Cliente.tipo_cliente ? data.Cliente.nombre.toUpperCase() + '<br><span class="font-12"> ' + $("#tribAcr").val() + ": " + data.Cliente.ruc + "</span>" : void 0
            }
        },{
            "data":null,
            "render": function ( data, type, row ) {
