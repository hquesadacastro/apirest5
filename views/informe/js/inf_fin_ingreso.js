...
var listar = function(){
    ...
    .DataTable({
        buttons: [
            {
                extend: 'excel', title: 'rep_ingresos', text:'Excel', className: 'btn btn-circle btn-lg btn-success waves-effect waves-dark', text: '<i class="mdi mdi-file-excel display-6" style="line-height: 10px;"><span class="botones-excel">Exportar excel</span></i>', titleAttr: 'Descargar Excel',
                container: '#btn-excel'
            }
        ],
        "destroy": true,
