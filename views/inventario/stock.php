                    ...
                    <div class="ml-auto float-right ">
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" style="overflow:auto">
                                ...
                                <a href="javascript:void();" id="downticket" tabindex="0" aria-controls="table" class="dropdown-item" title="Descargar Pdf"><span><i class="fas fa-file-pdf"></i> Descargar en Ticket</span></a>
                            </div>
                        </div>
                    </div>
