    ...
    var stock_min = 0,
        ...
        .DataTable({
            ...
            buttons: [
                {
                    extend: 'excel', 
                    title: 'Inventario de insumos y productos', 
                ...
                },
                {
                    ...
                    container: '#pdf', 
                    exportOptions: 
                    { columns: [0,1,2,3,4,5,6] }, orientation: 'landscape', 
            ...
            "columns":[
                {
                    ...
                    "render": function ( data, type, row) {
                        if(data.id_tipo_ins == 1){
                            return '<span class="text-white badge bg-warning">INSUMO</span>';
                        } else if(data.id_tipo_ins == 2 || data.id_tipo_ins == 3 ){
                            return '<span class="text-white badge bg-success">PRODUCTO</span>';
                        }
                    }
                },
