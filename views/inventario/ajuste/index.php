                ...
                <div class="card-body">
                    <ul class="list-group sortable-list">
                        <li class="list-group-item" style="background:#f1f1f1; font-size: 14px;">
                            <span>Insumo/Producto:</span> <span id="label-insumo"></span> - <span>Unidad de Medida:</span> <span class="text-white badge bg-danger" id="label-medida"></span>
                        </li>
                            ...
                            <div class="row" style="margin-bottom: -14px">
                                ...
                                <div class="col-sm-2">
                                    <div class="text-right">
                                        <button type="button" class="btn btn-circle-2 btn-primary btn-agregar-insumo"><i class="fas fa-plus"></i></button>
                                        <button type="button" class="btn btn-danger btn-eliminar-insumo"><i class="fas fa-trash"></i></button>
                                    </div>
                                </div>
                            </div> 
                        </li>
...
<script id="table-detalle-template" type="text/x-jsrender" src="">
    {{for items}} 
        <tr class="active">
            ...
            <td>
                <span class="text-white badge bg-danger" name="unidad_medida_insumo">{{:unidad_medida_insumo}}</span>
            </td>
            <td>
