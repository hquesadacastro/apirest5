        ...
        <div class="card">
            <div class="card-body p-b-0">
                <div class="card-body-1">
                    <h4 class="card-title">Ajuste de stock</h4>
                    <h2 class="add-ct-btn"><a href="<?php echo URL; ?>inventario/nuevoajuste"><button type="button" class="float-right btn btn-rounded btn-primary btn-nuevo">Nuevo</button></a></h2>                   
                </div>
                <br>
            </div>
