...
<div class="row">
    <div class="col-lg-5">
        <div class="card">        
            <div class="card-body"> 
                <button onclick="editarSalon();" class="float-right btn btn-rounded btn-primary btn-nuevo">Nueva</button>
                <h4 class="card-title">Listado de Salones y Mesas</h4>
            </div>
            <div class="card-body">
    ...
    <div class="col-lg-7">
        ...
        <div class="card" id="lizq-i" style="display: none;">        
            <div class="card-body">
                <button onclick="editarMesa();" class="float-right btn btn-rounded btn-primary btn-nuevo">Nueva</button>
