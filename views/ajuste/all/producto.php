    ...
    <div class="col-lg-3">
        <div class="card">
            <div class="card-body pb-0"> 
                <button class="float-right btn btn-rounded btn-primary btn-categoria-nuevo"><i class="ti-plus"></i></button>
                <h4 class="card-title">Categorías</h4>
            </div>        
            <div style="padding" class="card-body pt-0 pl-3 pr-1">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div style="padding: 0px !important;" class="card-body p-t-0 p-b-0 floating-labels">
                        <div class="row" style="margin-left: -20px; margin-right: -20px">
                            <!-- Column -->
                            <div class="col-lg-7 p-0">
                                <div class="row p-20">
                                    <div class="col-lg-0 mb-3 mb-sm-0">
                                        <button class="btn btn-primary btn-block btn-importar-producto" id="step2">Importar</button>
                                    </div>
                                    <div class="col-lg-4">
                                        <button class="btn btn-success btn-block btn-nuevo-producto" id="step2"><i class="fas fa-plus-circle"></i>Nuevo</button>
                                    </div>
                                    <div class="col-lg-6" id="filter_global">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="btn-group btn-group-toggle w-100" data-toggle="buttons">
                            <label class="btn waves-effect waves-light btn-outline-primary active" id="transf" data-original-title="Producto que debes PREPARAR ANTES DE VENDER, Ejm: Ceviches, parrillas o tragos" data-toggle="tooltip" data-placement="top">
                                <input type="radio" name="id_tipo" value="1" autocomplete="off"> Transformado
                            </label>
                            <label class="btn waves-effect waves-light btn-outline-primary" id="ntransf" data-original-title="Producto que has COMPRADO PARA VENDER, Ejm: Gaseosas, chifles" data-toggle="tooltip" data-placement="top">
...
<div class="modal inmodal" id="modal-presentacion" tabindex="-1" role="dialog" aria-hidden="true" data-backdrop="static" data-keyboard="true">
    <div class="modal-dialog modal-lg">
        ...
        <input type="hidden" name="producto_transformado" id="producto_transformado" value=""/>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="row floating-labels">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group f m-b-40 dec focused">
                                    <input type="text" class="form-control cbu" name="precio_compra" id="precio_compra" autocomplete="off" required="" data-fv-field="precio_compra">
                                    <span class="bar"></span>
                                    <label for="precio_compra">Costo Unitario - S/</label>
                                <div class="help-block" data-fv-validator="notEmpty" data-fv-for="precio_compra" data-fv-result="NOT_VALIDATED" style="display: none;">Dato obligatorio</div></div>
                            </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        ...
        <input type="hidden" name="id_prod_producto" id="id_prod_producto">
            ...
            <div class="modal-body">
                ...
                <div class="row mt-3">
                    <div class="col-12">
                    <a class="text-muted font-12 mr-auto" href="<?php echo URL; ?>/public/excel/productos.xlsx"><span class="text-white badge bg-success"><i class="fas fa-file-excel" aria-hidden="true"></i> Descargar excel de muestra</span></a>
