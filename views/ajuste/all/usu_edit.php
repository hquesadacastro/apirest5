...
if (isset($this->PermisosActuales)) {
    $PermisosActuales = $this->PermisosActuales;
} else {
                ...
                <div class="row">
                            ...
                            <div class="col-md-12"><br><br>
                                <div class="ct-wizard-azzure" id="wizardProfile">
                                    <div class="picture-container">
                                        <div class="picture">
                                        <?php if (isset($this->usuario['id_usu'])) { ?>
                    ...
                    <div class="col-md-6">
                        <div class="row floating-labels m-t-40">
                            ...
                            <div class="col-md-6">
                                <div class="form-group letMayMin m-b-40">
                                    <input type="text" class="form-control input-mayus" name="ape_paterno" id="ape_paterno" value="<?php echo $r = (isset($this->usuario['ape_paterno'])) ? $this->usuario['ape_paterno'] : ''; ?>" autocomplete="off"/>
                                    <span class="bar"></span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group letMayMin m-b-40">
                                    <input type="text" class="form-control input-mayus" name="ape_materno" id="ape_materno" value="<?php echo $r = (isset($this->usuario['ape_materno'])) ? $this->usuario['ape_materno'] : ''; ?>" autocomplete="off"/>
                                    <span class="bar"></span>
                            ...
                            <div class="col-md-12">
                                <div class="form-group m-b-40">
                                    <input type="text" class="form-control" name="email" id="email" value="<?php echo $r = (isset($this->usuario['email'])) ? $this->usuario['email'] : ''; ?>" autocomplete="off"/>
                                    <span class="bar"></span>
                            ...
                            <div class="col-sm-12 seleccion_permisos" id="rol-cajero">
                                <ul class="permisos">
                                <?php
                                foreach ($Permisos as $key => $value) {
                                    ...
                                    if ($id_rol == 3) {
                                        ...
                                        foreach ($PermisosActuales as $keyA => $valueA) {
                                            $id_permisoA = $valueA['id_permiso'];

                                            if ($id_permiso == $id_permisoA) {
                                                $seleccionado = "checked";
                                            }
                                        }
                            
                                        echo '<li><input type="checkbox" value="' . $id_permiso . '" name="permisosCajero[]" id="chk' . $id_permiso . '" class="chk-col-green" ' . $seleccionado . '><label for="chk' . $id_permiso . '">' . $descripcion . '</label></li>';
                                    }
                                }
                                ?>
                                </ul>
                            </div>
                            <div class="col-sm-12 seleccion_permisos" id="rol-mozo">
                                <ul class="permisos">
                                <?php
                                foreach ($Permisos as $key => $value) {
                                    $id_rol = $value['id_rol'];
                                    ...
                                    if ($id_rol == 5) {
                                        ...
                                        echo '<li><input type="checkbox" value="' . $id_permiso . '" name="permisosMozo[]" id="chk' . $id_permiso . '" class="chk-col-green" ' . $seleccionado . '><label for="chk' . $id_permiso . '">' . $descripcion . '</label></li>';
                                    }
                                }
                                ?>
                                </ul>
