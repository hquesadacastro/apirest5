	                                    ...
	                                    <table class="table table-condensed table-hover" width="100%">
	                                        ...
	                                        <tbody>
												...
												<td style="width:50px;">
	                                                ...
	                                                <td>
	                                                    <h5 class="m-t-5 m-b-0">Combos</h5><h6 class="text-muted">Envía comandas independientes para combos</h6>
	                                                </td>
	                                                <td class="text-right p-r-0" style="vertical-align: middle;">
	                                                	<div class="switch">
	                                                		<label><input type="checkbox" id="print_com_combo"><span class="lever switch-col-light-green"></span></label>
				                                        </div>
	                                                	<input type="hidden" name="print_com_combo" id="print_com_combo_hidden">
	                                                </td>
												</tr>													
												<tr>
	                                                <td style="width:50px;">
			                        ...
			                        <div class="row pt-4">
			                            <div class="col-md-6">
			                                <div class="form-group m-b-40">
			                                    ...
			                                    <span class="bar"></span>
			                                    <label for="cod_seg">Código de anulaciones para comandas</label>
			                                </div>
											<div class="form-group m-b-40">
			                                    <input type="text" name="cod_admin" id="cod_admin" class="form-control" autocomplete="off" required>
			                                    <span class="bar"></span>
