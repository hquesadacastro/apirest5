...
var listarCategorias = function() {
    ...
    $.ajax({
        ...
        success: function(item) {
            item.data.length > 0 ? $.each(item.data, function(item, campo) {
                $("#ul-cat").append($('<li class="row my-1"/>').html('<div class="col-auto mr-auto"><a href="javascript:void(0)" class="link" onclick="listarInsumos(' + campo.id_catg + ')">' + campo.descripcion + '</a></div><div class="col-auto"><div class="dropdown-action"><div class="dropdown todo-action-dropdown"><button class="btn btn-sm btn-outline-primary dropdown-toggle text-decoration-none todo-action-dropdown" type="button"id="more-action-3" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="icon-options-vertical"></i></button><div class="dropdown-menu dropdown-menu-right" aria-labelledby="more-action-3" style="overflow: auto;"><a class="edit dropdown-item pl-2" href="javascript:void(0);" onclick="editarCategoria(' + campo.id_catg + ",'" + campo.descripcion + '\')">Editar</a><a class="important dropdown-item pl-2" href="javascript:void(0);" onclick="eliminarCategoria(' + campo.id_catg + ')">Eliminar</a></div></div></div></div>'))
    ...
    .DataTable({
      ...
          }
        ...
        "columns":[
            ...
            {"data":null,"render": function ( data, type, row ) {
                return '<div class="text-right"><a href="javascript:void(0)" class="text-info edit" onclick="editarInsumo('+data.id_ins+')"><i data-feather="edit" class="feather-sm fill-white"></i>Editar insumo</a></div>';
            }}
        ]
    });
