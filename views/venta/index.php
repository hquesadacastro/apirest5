...
<div class="row">
    <div class="col-lg-8 u4 u4-2-1">
        <div class="card m-b-5">
            <!-- Nav tabs -->
            <ul class="nav nav-tabs bg-nav-pills nav-justified m-2" role="tablist">
                <li class="nav-item tab01"><a class="nav-link active" data-toggle="tab" href="#tabp-1" role="tab"><span class="hidden-xs-down">Mesas</span></a></li>
                <li class="nav-item tab02"><a class="nav-link" data-toggle="tab" href="#tabp-2" role="tab" onclick="mostrador()"><span class="hidden-xs-down">Mostrador</span></a></li>                
                <?php if(Session::get('rol') <> 10) { ?>
                <li class="nav-item tab03"><a class="nav-link" data-toggle="tab" href="#tabp-3" role="tab" onclick="delivery()"><span class="hidden-xs-down">Delivery <span class="label label-rounded label-inverse pedidos-total-1">0</span></span></a></li>
                <?php } ?>
                <form id="form-venta-rapida" method="post" enctype="multipart/form-data" action="<?php echo URL; ?>venta/pedido_create/pc2">
                    ...
                    <li class="nav-item tab04"><a class="nav-link"><button class="btn btn-xs btn-primary hidden-xs-down venta-rapida">VENTA RAPIDA</button></a></li> 
                </form>
            </ul>
            <!-- Tab panes -->
            <div class="tab-content">
                <div class="card-body display-estado-mesa p-t-0 p-b-0">
                    <div class="row">
                        <div class="col-md-5 col-8 align-self-center m-t-5">
                            <small class="label mesas-disponibles data-1" style="background: #21c1d6;" data-original-title="Mesa libre" data-toggle="tooltip" data-placement="right">&nbsp;Disponible</small>
                            <small class="label mesas-pago data-1" style="background: #1e88e5;" data-original-title="En proceso de pago" data-toggle="tooltip" data-placement="right">&nbsp;Por pagar</small>
                            <small class="label mesas-ocupadas data-1" style="background: #fc4b6c;" data-original-title="Mesa ocupada" data-toggle="tooltip" data-placement="right">&nbsp;Ocupado</small>
                        </div>
                        <div class="col-md-7 col-4 align-self-center">
                            <div class="d-flex m-t-10 justify-content-end">
                                <div class="d-flex m-l-0">
                                    <form method="post" enctype="multipart/form-data" action="<?php echo URL; ?>venta/refrescar_mesas">
                                        <button class="btn btn-sm btn-primary" type="submit" data-original-title="Refrescar mesas" data-toggle="tooltip" data-placement="left">Actualizar</button>
                                    </form>
                                        &nbsp;&nbsp;
                                    <?php if (strlen($key_9) == 0) { ?>
                                    <div class="btn-group">
                ...
                <div class="tab-pane p-0 active" id="tabp-1" role="tabpanel">
                    <div class="customvtab">
                        <div class="tab-content w-100" style="padding-bottom: 10px;">
                            <ul class="scroll_horizontal nav nav-tabs nav-bordered mb-3 customtab d-md-flex">
                            ...
                            <div class="tab-pane tp<?php echo $cont++; ?>" id="tab-<?php echo $value['id_salon']; ?>" role="tabpanel">
                                <div class="row">
                                    <div class="col-12 scroll_mesas mesas_new">

                                    <ul class="grid list-mesas" data-toggle="buttons"></ul>
                                    </div>
                                </div>
                            </div>
                            <?php endforeach; ?>
                ...
                <div class="tab-pane" id="tabp-2" role="tabpanel">
                    <ul class="nav nav-tabs customtab" role="tablist">
                        <li class="nav-item mostrador01" data-toggle="tooltip" data-placement="bottom" data-original-title="Esperando confirmaci&oacute;n"> <a class="nav-link active" data-toggle="tab" href="#mostrador01" role="tab"><span class="hidden-xs-down"><i class="fas fa-bullhorn font-20"></i></span></a> </li>
                        <li class="nav-item mostrador02" data-toggle="tooltip" data-placement="bottom" data-original-title="Pedidos en preparaci&oacute;n"> <a class="nav-link" data-toggle="tab" href="#mostrador02" role="tab"><span class="hidden-xs-down"><i class="fas fa-diagnoses font-20"></i></span></a> </li>
                        <li class="nav-item mostrador03" data-toggle="tooltip" data-placement="bottom" data-original-title="Pedidos entregados"> <a class="nav-link" data-toggle="tab" href="#mostrador03" role="tab"><span class="hidden-xs-down"><i class="fas fa-hands-helping font-20"></i></span></a> </li>
                    </ul>
                    <!-- Tab panes -->
                    <div class="tab-content">
                ...
                <div class="tab-pane" id="tabp-3" role="tabpanel">
                    ...
                    <ul class="nav nav-tabs customtab" role="tablist">
                        <li class="nav-item delivery01" data-toggle="tooltip" data-placement="top" data-original-title="Esperando confirmaci&oacute;n"> <a class="nav-link active" data-toggle="tab" href="#delivery01" role="tab"><span class="hidden-xs-down"><i class="fas fa-bullhorn font-20"></i> <span class="label label-rounded label-inverse pedidos-total-1">0</span></span></a> </li>
                        <li class="nav-item delivery02" data-toggle="tooltip" data-placement="top" data-original-title="Pedidos en preparaci&oacute;n"> <a class="nav-link" data-toggle="tab" href="#delivery02" role="tab"><span class="hidden-xs-down"><i class="fas fa-diagnoses font-20"></i></span></a> </li>
                        <?php if(Session::get('rol') <> 5) { ?>
                        <li class="nav-item delivery03" data-toggle="tooltip" data-placement="top" data-original-title="Pedidos en camino"> <a class="nav-link" data-toggle="tab" href="#delivery03" role="tab"><span class="hidden-xs-down"><i class="fas fa-motorcycle font-20"></i></span></a> </li>
                        <li class="nav-item delivery04" data-toggle="tooltip" data-placement="top" data-original-title="Pedidos entregados"> <a class="nav-link" data-toggle="tab" href="#delivery04" role="tab"><span class="hidden-xs-down"><i class="fas fa-hands-helping font-20"></i></span></a> </li>
                        <?php } ?>
                    </ul>
                    <!-- Tab panes -->
                    <div class="tab-content">
                ...
                <div class="scroll_pedidos">
                    <div class="cont01 justify-center" style="height: 100%;">
                        ...
                        <div class="text-center cont01-2" style="display: none;">
                            <h2 class="text-white"><button type="button" class="btn btn-orange waves-effect waves-dark btn-nuevo-pedido"><i class="ti-plus"></i>Añadir</button></h2>
                        ...
                        <div class="row p-t-0 p-l-20 p-r-20 p-b-10">
                            <div class="col-md-12 m-b-40 display-tipo-entrega" style="display: none;">
                                ...
                                <div class="btn-group btn-group-toggle w-100" data-toggle="buttons">
                                    <label class="btn waves-effect waves-light btn-outline-primary active">
                                        <input type="radio" name="tipo_entrega" id="tipo_entrega_1" value="1" autocomplete="off" checked> A DOMICILIO
                                    </label>
                                    <label class="btn waves-effect waves-light btn-outline-primary">
                            ...
                            <div class="col-md-6 display-hora-entrega floating-labels" style="display: none;">
                                <div class="form-group m-b-40">
                                    <select class="selectpicker form-control bg-t" name="hora_entrega" id="hora_entrega" data-style="form-control btn-default" title="Seleccionar" autocomplete="off" data-size="5" required>
                                        <optgroup>
                            ...
                            <div class="col-sm-12 display-repartidor floating-labels" style="display: none;">
                                <div class="form-group m-t-40 m-b-0">
                                    <select class="selectpicker form-control bg-t" name="id_repartidor" id="id_repartidor" data-style="form-control btn-default" title="Seleccionar" data-live-search-style="begins" required>
                                        ...
                                        <optgroup>
                                            ...
                                            <option value="3333">PEDIDOSYA</option>
                            ...
                            <div class="col-sm-12 display-personas floating-labels" style="display: none;">
                                <div class="form-group m-t-20 m-b-40">
                                    <input id="tch3" name="nro_personas" type="text" value="1" class="form-control text-center bg-t numero-personas" style="border-bottom: 1px solid #d9d9d9; margin-top: 1px;" readonly/>
                                    <label form="tch3">Nro de personas</label>
                                </div> 
                            </div>
                            <div class="col-sm-12 display-mozo floating-labels" style="display: none;">
                                <div class="form-group m-b-40">
                                    <select class="selectpicker form-control bg-t" name="id_mozo" id="id_mozo" data-style="form-control btn-default" title="Seleccionar" data-live-search-style="begins" required>
...
<div id="card2"></div>
<div class="">
    <button class="waves-effect waves-light btn-custom btn-inverse btn-up hidden-lg-up" style="bottom: 65px"><i class="ti-arrow-circle-up text-white"></i></button>
    <button class="waves-effect waves-light btn-custom btn-inverse btn-down hidden-lg-up" style="bottom: 10px"><i class="ti-arrow-circle-down text-white"></i></button>
</div>
            ...
            <div class="modal-body p-0">     
                <div class="row floating-labels" style="margin-left: 0px; margin-right: 0px;">
                    <div class="col-sm-6 bg-light-inverse">
                        ...
                        <div class="form-group m-b-40">
                            <select class="selectpicker form-control" id="cod_salon_origen_opc01" data-style="form-control btn-default bg-transparent" title="Seleccionar" data-live-search-style="begins" required>
                        ...
                        <div class="form-group m-b-30">
                            <select class="selectpicker form-control" name="cod_mesa_origen_opc01" id="cod_mesa_origen_opc01" data-style="form-control btn-default bg-transparent" title="Seleccionar" data-live-search-style="begins" title="Seleccionar" required="required" data-size="5">
                    ...
                    <div class="col-sm-6 bg-header b-l">
                        ...
                        <div class="form-group m-b-40">
                            <select class="selectpicker form-control" id="cod_salon_destino_opc01" data-style="form-control btn-default bg-transparent" title="Seleccionar" data-live-search-style="begins" required>
                                <?php foreach($this->Salon as $key => $value): ?>
                                <option value="<?php echo $value['id_salon']; ?>"><?php echo $value['descripcion']; ?></option>
                                <?php endforeach; ?>
                            </select>
                        ...
                        <div class="form-group m-b-30">
                            <select class="selectpicker form-control" name="cod_mesa_destino_opc01" id="cod_mesa_destino_opc01" data-style="form-control btn-default bg-transparent" title="Seleccionar" data-live-search-style="begins" title="Seleccionar" required="required" data-size="5">
                                <option value="0"></option>
                            </select>
                            <span class="bar"></span>
            ...
            <div class="modal-body p-0">     
                <div class="row floating-labels" style="margin-left: 0px; margin-right: 0px;">
                    <div class="col-sm-6 bg-light-inverse">
                        <h5 class="m-t-30 m-b-40"><i class="ti-angle-double-down"></i> Origen</h5>
                        <div class="form-group m-b-40">
                            <select class="selectpicker form-control" id="cod_salon_origen_opc02" data-style="form-control btn-default bg-transparent" title="Seleccionar" data-live-search-style="begins" required>
                                <?php foreach($this->Salon as $key => $value): ?>
                                <option value="<?php echo $value['id_salon']; ?>"><?php echo $value['descripcion']; ?></option>
                                <?php endforeach; ?>
                            </select>
                        ...
                        <div class="form-group m-b-30">
                            <select class="selectpicker form-control" name="cod_mesa_origen_opc02" id="cod_mesa_origen_opc02" data-style="form-control btn-default bg-transparent" title="Seleccionar" data-live-search-style="begins" title="Seleccionar" required="required" data-size="5">
                                <option value="0"></option>
                            </select>
                            <span class="bar"></span>
                    ...
                    <div class="col-sm-6 bg-header b-l">
                        <h5 class="m-t-30 m-b-40"><i class="ti-angle-double-up"></i> Destino</h5>
                        <div class="form-group m-b-40">
                            <select class="selectpicker form-control" id="cod_salon_destino_opc02" data-style="form-control btn-default bg-transparent" title="Seleccionar" data-live-search-style="begins" required>
                                <?php foreach($this->Salon as $key => $value): ?>
                                <option value="<?php echo $value['id_salon']; ?>"><?php echo $value['descripcion']; ?></option>
                                <?php endforeach; ?>
                            </select>
                        ...
                        <div class="form-group m-b-30">
                            <select class="selectpicker form-control" name="cod_mesa_destino_opc02" id="cod_mesa_destino_opc02" data-style="form-control btn-default bg-transparent" title="Seleccionar" data-live-search-style="begins" title="Seleccionar" required="required" data-size="5">
                                <option value="0"></option>
                            </select>
                            <span class="bar"></span>
                ...
                <div class="row floating-labels m-t-40">
                    <div class="col-md-12 display-pedido-repartidor-edit" style="display: block;">
                        <div class="form-group m-b-40 cbu">
                            <select class="selectpicker form-control p-0" name="id_repartidor_edit" id="id_repartidor_edit" data-style="form-control btn-default" title="Seleccionar" data-size="5" data-live-search-style="begins" autocomplete="off" >
                                <?php foreach($this->Repartidor as $key => $value): ?>
                                <option value="<?php echo $value['id_usu']; ?>"><?php echo $value['nombres'].' '.$value['ape_paterno'].' '.$value['ape_materno']; ?></option>
                                <?php endforeach; ?>
                                <optgroup>
                    ...
                    <div class="col-md-12 display-entrega-programada floating-labels" style="display: block;">
                        <div class="form-group m-b-40">
                            <select class="selectpicker form-control" name="hora_entrega_edit" id="hora_entrega_edit" data-style="form-control btn-default" title="Seleccionar" autocomplete="off" data-size="5">
                                <optgroup>
                                    <option value="10:00:00">10:00 AM</option>
                                    <option value="10:30:00">10:30 AM</option>
                                    <option value="11:00:00">11:00 AM</option>
                    ...
                    <div class="col-sm-12 display-tipo-pago floating-labels" style="display: block">
                        <div class="form-group m-b-40">
                            <select class="selectpicker form-control" name="id_tipo_pago" id="id_tipo_pago" data-style="form-control btn-default" data-live-search-style="begins">
        ...
        <form id="form-editar-venta-pago" method="post" enctype="multipart/form-data">
            ...
            <div class="modal-body">
                <div class="row floating-labels m-t-40">
                    <div class="col-sm-12 display-tipo-pago floating-labels" style="display: block">
                        <div class="form-group m-b-40">
                            <select class="selectpicker form-control" name="id_tipo_pago_v" id="id_tipo_pago_v" data-style="form-control btn-default" data-live-search-style="begins">
                                <?php foreach($this->TipoPago as $key => $value): ?>
                                    <option label="<?php echo $value['id_pago']; ?>" value="<?php echo $value['id_tipo_pago']; ?>"><?php echo $value['descripcion']; ?></option>
                                <?php endforeach; ?>
                            </select>
