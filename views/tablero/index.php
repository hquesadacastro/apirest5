                ...
                <div class="row floating-labels m-t-20">
                    <div class="col-sm-12">
                        <div class="form-group">
                            <select class="selectpicker form-control" name="id_caja" id="id_caja" data-style="form-control btn-default" data-size="5" autocomplete="off" required>
...
<div class="row">
    <div class="col-lg-4">
        <div class="card">
            <div class="card-body p-0">
                ...
                <div class="table-responsive b-t m-b-0 table-scroll">
                    ...
                    <table class="table stylish-table">
                        <thead class="table-head">
                            <tr>
                                ...
                                <th class="text-center" width="135">Estado</th>
                                <th class="text-center" width="90">Comprar</th>
                            </tr>
                        </thead>
                        <tbody id="lista_productos_agotarse"></tbody>
                    </table>
                </div>
            </div>
        </div>
    ...
    <div class="col-lg-4">
        <div class="card">
            <div class="card-body p-0">
                <div class="d-flex no-block p-20">
                    <h4 class="card-title">Insumos por Agotarse</h4>
                </div>
                <div class="table-responsive b-t m-b-0 table-scroll">
                    <table class="table stylish-table">
                        <thead class="table-head">
                        ...
                        <tbody id="lista_insumos_agotarse"></tbody>
                    </table>
                </div>
            </div>
        </div>
