        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="d-flex flex-wrap">
                    ...
                    <div class="ml-auto"><button type="button" class="btn btn-xs btn-danger" id="btnProvLimpiar"><i class="fas fa-eraser"></i>Eliminar</button> <button type="button" class="btn btn-xs btn-success" onclick="nuevoProveedor();"><i class="fas fa-plus"></i> Nuevo </button></div>
                </div>
        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="row floating-labels">
                    ...
                    <div class="col-sm-2 dec">
                        <input type="text" id="precio_buscar" class="form-control bg-t text-center" autocomplete="off" placeholder="Precio costo"/>
                        <span class="bar"></span>
                    </div>
                    <div class="col-sm-1">
                        <button class="btn btn-block btn-circle btn-primary" id="btn-agregar-insumo" type="button"><i class="fas fa-plus-circle"></i></button>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-sm-5">
                        <div id="mensaje-credito" style="display: none;">
                            <div class="alert alert-warning m-b-0">Click <a href="javascript:void(0)" class="alert-link link-credito-1"><span class="label label-success-2">AQUI</span></a> para poder ingresar las cuotas de la compra.</div>
                        </div>
                    </div>
                    <div class="col-sm-7">
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <div class="text-right floating-labels dec">
                                    <span class="text-muted text-adicional">Adicional</span><br>
                                    <input type="text" id="total_adicional" class="form-control text-right" value="0.00" autocomplete="off"/>
                                    <span class="bar"></span>
                                </div>
                            </div>
                            <div class="col-sm-4">
...
<script id="table-detalle-template" type="text/x-jsrender" src="">
    ...
    <tr class="warning-element active">
        ...
        <td style="width: 10%;">
            <span class="text-white badge bg-success" name="unidad_medida_insumo">{{:unidad_medida_insumo}}</span>
        </td>
