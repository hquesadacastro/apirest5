...
var listar = function(){
    ...
    .DataTable({
        ...
            }},
            ...
            {"data":null,"render": function ( data, type, row ) {
                if(data.estado == 'a'){
                    return '<div class="text-center"><a href="javascript::void(0)" onclick="estado('+data.id_prov+',\''+data.estado+'\',\''+data.razon_social+'\''+');"><span class="p-1 badge badge-success">ACTIVO</span></a></div>';
            ...
            {"data":null,"render": function ( data, type, row ) {
                return '<div class="text-right"><a href="javascript:void(0)" class="text-info edit" onclick="editar('+data.id_prov+');"><i data-feather="edit" class="feather-sm fill-white"></i>Editar Proveedor</a></div>';
            }}
        ],
