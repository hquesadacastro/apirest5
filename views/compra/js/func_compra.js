            ...
            }},
            {
                ...
                "render": function ( data, type, row) {
                    if(data.id_tipo_compra == 1){
                        return '<div class="text-left"><span class="text-white badge bg-primary">'+data.desc_tc+'</span></div>';
                    } else if(data.id_tipo_compra == 2){
                        return '<div class="text-left"><span class="text-white badge bg-warning">'+data.desc_tc+'</span></div>';
                    }
                }
            },
            {"data":null,"render": function ( data, type, row ) {
        ...
        $.each(data, function(i, item) {
            ...
            .append(
              $('<tr/>')
                ...
                .append($('<td/>').html(cantidad.toFixed(6)+' <span class="p-1 badge badge-warning">'+item.Producto.ins_med+'</span>'))
