...
var cierre = function(){
    ...
    var html_print = '<div>El turno de caja ha sido cerrada.<br>Puede imprimir el arqueo de caja, para obtener el detalle de sus procesos.</div>\
        <br><div class="text-center"><a href="'+$("#url").val()+'informe/finanza_arq_imp/'+$('#id_apc').val()+'" target="_blank"><span class="text-white badge bg-success font-15 py-2"><i class="fas fa-print font-15"></i> Arqueo de caja</a></div><br>\
        ';
    Swal.fire({
        title: 'Necesitamos de tu Confirmación',
        html: html_confirm,
