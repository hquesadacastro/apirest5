                                        ...
                                        <div class="form-group m-b-20 dec">
                                            ...
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text bg-white text-muted style2" style="display: grid;">
                                                        <small class="text-left">EFE</small>
                                                        <div class="text-left font-medium"><?php echo Session::get('moneda'); ?></div>
                                                    </span>
                                                </div>
                                                <input type="text" name="onlyNum" class="form-control form-control-lg" style="height: 58px !important;border-left: 0px; border-right: 0px;" name="monto_aper" id="monto_aper" value="" autocomplete="off" required>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group m-t-20 m-b-20 dec">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="onlyNum" class="form-control form-control-lg" style="height: 58px !important;border-left: 0px; border-right: 0px;" name="monto_cierre" id="monto_cierre" value="" autocomplete="off" required>
                                                <div class="input-group-append">
                                                    <span class="input-group-text bg-white text-muted"><?php echo Session::get('monAcr'); ?></span>
                                                </div>
                                            </div>                           
    ...
    <div class="col-lg-5">
        <div class="card">
            <div class="card-body p-0">
               <h5 class="m-3">Listado de cajas aperturadas</h5>
               <div class="table-responsive b-t m-b-0">
                    <table class="table table-hover table-condensed stylish-table">
