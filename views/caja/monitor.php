...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body p-10 display-two" style="display: block;">
                        ...
                        <div class="card-body p-b-0"><br>
                            <div class="message-box contact-box">
                                <div class="row floating-labels">
                                    <div class="col-lg-4">
                                        <div class="form-group m-b-40">
                                            <div class="input-group">
                                                <input type="text" class="form-control font-14 text-center" name="start" id="start" value="<?php echo $fecha; ?>" autocomplete="off"/>
                                    ...
                                    <div class="col-sm-6 col-lg-2 m-b-40">
                                ...
                                <table id="table-ventas" class="table table-condensed table-hover stylish-table" style="margin-top: 0px !important;" width="100%">
                                    <thead class="table-head">
                                        <tr>
                                            ...
                                            <th width="">Cliente</th>
                                            <th width="12%">Canal venta</th>
                                            <th width="10%" class="text-right">Tipo pago</th>
                                            <th width="10%" class="text-right">Total</th>
                                            <th width="8%" class="text-right">Opciones</th>
                                        </tr>
                                    </thead>
                                    <tbody class="tb-st"></tbody>
                                </table>
                ...
                <div class="row floating-labels m-t-0">
                    <div class="col-sm-12 display-tipo-pago floating-labels" style="display: block">
                        <div class="form-group m-b-0">
                            ...
                            <span class="bar"></span>
                            <label style="width:100%; text-align:center;" for="id_tipo_pago_v">Tipo pago</label>
                        </div>
                    </div>
                </div>
            </div>
            <?php if (strlen($key_5) == 0) { ?>
                <?php } else { ?>
                <div class="col-lg-12">
                    <div class="input-group">
                        <label style="width:100%; text-align:center;" class="font-13 text-inverse">Ingrese codigo de seguridad</label>
                    </div>
                    <div class="input-group">
                        <input class="form-control text-center w-50" type="password" id="codigo_editar_pago" autocomplete="off"/>
                    </div>
                </div>
            <?php } ?>
    ...
    <div class="modal-dialog modal-md modal-dialog-centered">
        ...
        <form id="form-editar-documento" class="form-editar-documento" method="post" enctype="multipart/form-data">
            ...
            <div class="modal-body">
                ...
                <?php if (strlen($key_4) == 0) { ?>
                <?php } else { ?>
                <div class="col-lg-12">
                    <div class="input-group">
                        <label class="font-13 text-inverse">Ingrese codigo de seguridad</label>
                    </div>
                    <div class="input-group">
                        <input class="form-control text-center w-50" type="password" id="codigo_editar_documento" autocomplete="off"/>
                    </div>
                </div>
                <?php } ?>
            </div>
