        ...
        <div class="card">         
            <div class="card-body p-b-0">
                <div class="card-body-1">
                    <h4 class="card-title">Todas los Egresos</h4>
                    <h2 class="add-ct-btn"><button type="button" class="float-right btn btn-rounded btn-primary btn-nuevo" data-toggle="modal" data-target="#modal"><i class="ti-plus"></i>Nuevo</button></h2>
                </div>
            </div>
                    ...
                    <div class="col-sm-12">
                        <div class="form-group m-b-40 cbu">
                            <select class="selectpicker form-control p-0" name="id_tipo_gasto" id="id_tipo_gasto" data-style="form-control btn-default" title="Seleccionar" autocomplete="off" required="required">
                                ...
                                <option value="2">Servicios</option>
                                <option value="3">Remuneraciones</option>
                                <option value="5">Pago Delivery</option>
                            </select>
                            <span class="bar"></span>
