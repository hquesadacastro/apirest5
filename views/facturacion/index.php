...
<input type="hidden" id="igvdec" value="<?php echo igv_dec; ?>"/>
<input type="hidden" id="igvdec2" value="<?php echo igv_dec2; ?>"/>
...
<input type="hidden" id="nom_empresa" value="Sistema | Alpharest.pe"/>
<input type="hidden" id="token_whatsapp" value="EAAJrDf03C5cBO5zs30sXeac1kMR0aZCmwt2IhxOzvxmvaDdkAzv4ejSzJPA7LdoqCxxl7hZA31vr4ipgcVTy0UIXBqdDZBc55T3Ip9nfh3EdWY7i39H6ROYKSmIPQh7nxISMzfIXsQGZCp10LNzJqia0NFAW59EIi7UhGEMIGgao9D0n68ZAvOr9ZBqwcOwzak"/>
                    ...
                    <div class="card-body p-b-0">
                        <div class="message-box contact-box">
                            ...
                            <div class="row floating-labels">
                                ...
                                <div class="col-sm-6 col-lg-2">
                                    <div class="form-group m-b-40">
                                        <input type="text" class="form-control global_filter" id="global_filter" autocomplete="off" placeholder="Ingrese N° de correlativo">
                                        <span class="bar"></span>
                                        <label for="global_filter">Buscar comprobante</label>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-lg-2">
                                    <div class="form-group m-b-40">
                            ...
                            <div class="m-b-20">
                                <div class="row">
                                    ...
                                    <div class="col-1 text-center">
                                        <h2 class="font-medium font-xs text-warning m-b-0 font-22" id="total_enviados"></h2>
                                        <h6 class="font-bold m-b-10">ENVIADOS</h6>                            
                                    </div>
                                    <div class="col-1 text-center">
                                        <h2 class="font-medium font-xs text-warning m-b-0 font-22" id="total_noenviados"></h2>
                                        <h6 class="font-bold m-b-10">NO ENVIADOS</h6>
                                    </div>
                                    <div class="col-1 text-center">
                                        <h2 class="font-medium font-xs text-warning m-b-0 font-22" id="total_facturas"></h2>
                                        <h6 class="font-bold m-b-10">FACTURAS</h6>
                                    </div>
                                    <div class="col-1 text-center">
                                        <h2 class="font-medium font-xs text-warning m-b-0 font-22" id="total_boletas"></h2>
                                        <h6 class="font-bold m-b-10">BOLETAS</h6>
                                    </div>
                                    <div class="col-1 text-center">
                                        <h2 class="font-medium font-xs text-warning m-b-0 font-22" id="total_anulados"></h2>
                                    ...
                                    <div class="col-1 text-center">
                                        <h2 class="font-medium font-xs text-warning m-b-0 font-22" id="totalMontoBoleta"></h2>
                                        <h6 class="font-bold m-b-10">BOLETAS</h6>
                                    </div>
                                    <div class="col-1 text-center">
                                        <h2 class="font-medium font-xs text-warning m-b-0 font-22" id="totalMontoFactura"></h2>
                                        <h6 class="font-bold m-b-10">FACTURAS</h6>
                                    </div>
                                    <div class="col-1 text-center">
                                        <h2 class="font-medium font-xs text-warning m-b-0 font-22" id="totalMontoAnulados"></h2>
                                        <h6 class="font-bold m-b-10">ANULADOS</h6>
                                    </div>
                                    <div class="col-1 text-center">
                                        <h2 class="font-medium font-xs text-warning m-b-0 font-22" id="totalIGV"></h2>
                                        <h6 class="font-bold m-b-10">T. IGV</h6>
                                    </div>
                                    <div class="col-1 text-center">
                                        <h2 class="font-medium font-xs text-warning m-b-0 font-22" id="totalGravado"></h2>
                                        <h6 class="font-bold m-b-10">T. Gravado</h6>
                                    </div>
                                    <div class="col-1 text-center">
                                        <h2 class="font-medium font-xs text-warning m-b-0 font-22" id="totalMontoTotal"></h2>
