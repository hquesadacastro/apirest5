...
class ApiModel
{
    ...
    public function getCabecera($cod_ven)
    {
        ...
        {      
            ...
            IF(tm_venta.id_tipo_doc=1,(IF(tm_cliente.tipo_cliente=1,tm_cliente.dni,tm_cliente.ruc)),tm_cliente.ruc) AS numero_documento,
            IF(tm_venta.id_tipo_doc=1,(IF(tm_cliente.tipo_cliente=1,tm_cliente.nombres,tm_cliente.razon_social)),tm_cliente.ruc) AS razon_social, 
            ...
            $c->{'Detalle'} = $this->db->query("SELECT v_productos.pro_cod AS codigo_producto, 
                ...
                IF(v_productos.pro_imp='1',ROUND((tm_detalle_venta.precio/(1+ ".igv_dec.")),6),tm_detalle_venta.precio) AS valor_unitario,
