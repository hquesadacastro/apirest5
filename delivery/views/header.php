...
<link rel="apple-touch-icon" href="<?php echo URL; ?>public/img/favicon_60x60.png">
<link rel="apple-touch-icon" sizes="76x76" href="<?php echo URL; ?>public/img/favicon_76x76.png">
<link rel="apple-touch-icon" sizes="120x120" href="<?php echo URL; ?>public/img/favicon_120x120.png">
<link rel="apple-touch-icon" sizes="152x152" href="<?php echo URL; ?>public/img/favicon_152x152.png">
            ...
            <div class="row">
                <div class="col-md-3">
                    ...
                    <div class="module module-logo light">
                        <a href="<?php echo URL; ?>">
                            <img src="<?php echo URL; ?>public/img/logo.png" height="88" alt="">
                        </a>
                    </div>
                </div>
                <div class="col-md-7">
