...
<footer id="footer" class="bg-dark dark">
    ...
    <div class="container">
        ...
        <div class="footer-second-row">
            <span class="text-muted">Desarrollado por <a href="https://www.facebook.com/cuscotechnology21" target="_blank"><span class="text-danger">Cusco Technology</span></a></span>
        </div>
    </div>
