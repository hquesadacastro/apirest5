    ...
    public function sendEmail($correo_cliente,$documento_cliente,$datos_factura,$negocio) {
        ...
        try {
            ...
            */
            ...
            $mail->Host = 'mail.alpharest.pe';
            $mail->SMTPAuth = true;

            $mail->Username = 'cpe@alpharest.pe';
            $mail->Password = '27DEsetiembre#';
            ...
            ## MENSAJE A ENVIAR
            $mail->setFrom('cpe@alpharest.pe', $negocio);
            $mail->addAddress($correo_cliente);

            $mail->isHTML(true);
            $mail->Subject = $data['Empresa']['razon_social'] . ' - ' . 'Envio de C.P.E' . ' - ' . $data['ser_doc'] . '-' . $data['nro_doc'];
            $mail->Body = 'Sr(es),
            <br>'. utf8_decode($data['Cliente']['nombre']) .'</br>
            <br> </br>
            <br>Le informamos que ha recibido un documento de ' . $data['Empresa']['razon_social'] . ' en Alpharest.pe </br>
            <br> </br>
            <br><b>Número de documento:</b> ' . $data['ser_doc'] . '-' . $data['nro_doc'] . '</br>
            <br><b>Tipo:</b> ' . $data['desc_td'] . '</br>
            <br><b>Fecha de emisión:</b> ' . date('d-m-Y h:i A',strtotime($data['fec_ven'])) . '</br>
            <br><b>Valor:</b> S/.' . number_format(($data['total'] + $data['comis_del'] - $data['desc_monto']),2) . '</br>
            <br>Si requiere consultar el documento en por favor ingrese a https://ww3.sunat.gob.pe/ol-ti-itconsvalicpe/ConsValiCpe.htm </br>
            <br> </br>
            <br>Si tiene inquietud respecto a la información contenida en la factura/boleta electrónica debe comunicarse con ' . $data['Empresa']['razon_social'] . '</br>
            <br> </br>
            <br>Atentamente,</br>
            <br> </br>
            <br>Facturación Electrónica</br>
            <br><a href="https://alpharest.pe">Alpharest.pe</a></br>
            <br> </br>
            <br>---------------------------------------------------------------------------------------</br>
            <br>Este es un sistema automático de aviso, por favor no responda este mensaje al correo.</br>
            <br>---------------------------------------------------------------------------------------</br>';       
